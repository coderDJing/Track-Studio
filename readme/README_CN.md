...
**Track Studio** 是一款面向 DJ 和音乐收藏整理场景的桌面音频工作流工具。它把真实文件整理、SET 歌单准备、波形试听、指纹去重、Rekordbox 与 Pioneer 库读取、段落与能量分析、本地库合并、双轨横推试听、录音、元数据补齐、格式转换、相似歌曲发现、精选库与指纹云同步、单曲 Stem 分离和 Mixtape 编排整合在同一个 Windows/macOS 应用里。
