    ...
    try {
      ...
      recordPlaylistOpenPath({
        ...
        details: {
          ...
          cacheRootResolveMs: result.perf?.cacheRootResolveMs,
          identityDigestMs: result.perf?.identityDigestMs,
          waveformAvailabilityMs: result.perf?.waveformAvailabilityMs,
          ...
          cacheLoadedFromDb: result.perf?.cacheLoadedFromDb,
          cacheRows: result.perf?.cacheRows,
          cacheHits: result.perf?.cacheHits,
          cacheMisses: result.perf?.cacheMisses,
